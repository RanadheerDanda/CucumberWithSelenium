...
public class TaggedHooksStepDefinition {
	...
	@Before(order=0)
	public void setUP(){
		System.out.println("launch FF 0");
		System.out.println("Enter URL for Free CRM APP 0");
	}

	@After(order=0)
	public void tearDown(){
		System.out.println("close the browser 0");
	}
	
	@Before(order=1)
	public void setUP1(){
		System.out.println("launch FF 1");
		System.out.println("Enter URL for Free CRM APP 1");
	}
