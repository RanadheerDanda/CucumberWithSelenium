$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("G:/Ranadheer Workspace/CucumberWithSelenium/src/main/java/features/dealsmap.feature");
formatter.feature({
  "line": 1,
